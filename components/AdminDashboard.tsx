                  ...
                  <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 animate-in slide-in-from-right">
                      <div className="flex justify-between items-center mb-4 border-b border-slate-200 pb-4">
                          <div>
                              ...
                              <p className="text-[10px] text-blue-600 font-bold mt-1">💡 Tip: For permanent links, edit "src/data/staticContent.ts" in GitHub.</p>
                          </div>
      ...
      {activeTab.startsWith('CONFIG_') && (
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 animate-in slide-in-from-bottom-4">
              ...
              <div className="bg-blue-50 border border-blue-200 p-4 rounded-xl mb-6">
                  <p className="text-xs text-blue-800 font-bold">⚠️ NOTICE: Changes made here only affect YOUR browser (Local Mode). To update global settings (e.g. Notices, Maintenance Mode) for ALL users, you must edit `src/data/staticSettings.ts` in GitHub.</p>
              </div>
